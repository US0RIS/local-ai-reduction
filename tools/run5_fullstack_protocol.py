#!/usr/bin/env python3
"""Canonical controlled Run-5 protocol.

This is intentionally self-contained so promoted L2C artifacts have a committed
training/evaluation generator. It is CPU-heavy. It trains five seeds, converts
a 16-independent-block teacher to one shared block, function-prefits that block,
performs hard-projected group-64 QAT recovery, then evaluates group-3 latent-Q2
KV against the project's row-Q4 teacher baseline on the same 100,032 characters.
"""
